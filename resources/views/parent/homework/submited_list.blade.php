  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>Student Submited Homework<span style="color: blue;">({{ $getStudent->name }} {{ $getStudent->last_name }})</span></h1>
          </div>
        ...
        <div class="row">
          ...
          <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Search My Student Submited Homework</h3>
              </div>
              ...
              <form method="get"  action="" > 
                <div class="card-body">
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <input type="date" class="form-control" name="from_homework_date" value="{{ Request::get('from_homework_date') }}" placeholder="">
                    </div>
                    <div class="form-group col-md-2">
                    ...
                    <a href="{{ url('parent/my_student/submitted_homework/'.$getStudent->id)}}" class="btn btn-success" style="margin-top: 30px;">Reset</a>
                    </div>
                   </div>
                  </div>
              </form>
          ...
          @include('_message')
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Student Homework Submited List</h3>
              </div>
