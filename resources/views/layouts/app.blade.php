...
<head>
  ...
  <!-- Fallback: Local Font Awesome (optional, remove if not needed) -->
  <link rel="stylesheet" href="{{ url('public/plugins/fontawesome-free/css/all.min.css') }}" media="all and (max-width:0px)">
