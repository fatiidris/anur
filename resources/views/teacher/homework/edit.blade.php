        ...
        <div class="row">
          ...
          @include('_message')
            <div class="card card-primary">
              <!-- form start -->
              <form method="post"  action="{{ url('teacher/homework/homework/edit/'. $getRecord->id) }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="homework_date" value="{{ $getRecord->homework_date }}" placeholder="" required>
                    </div>
                    <div class="form-group">
                    <label>Submission Date<span style="color: red;">*</span></label>
                    <input type="date" class="form-control" value="{{ $getRecord->submission_date }}" name="submission_date">
                    </div>
                    <div class="form-group">
                    <label>Document</label>
                    <input type="file" class="form-control" name="document_file" placeholder="">
