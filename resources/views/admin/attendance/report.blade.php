    ...
    <!-- Content Header (Page header) -->
          <section class="content-header">
            ...
            <div class="card-header">
              ...
              <!-- form start -->
              <form method="GET" action="{{ url('admin/attendance/report') }}">
              @csrf
                <div class="card-body">
                  <div class="row">
                  <div class="form-group col-md-2">
                    <label>Student ID</label>
                    <input type="text" class="form-control" value="{{ Request::get('student_id')}}" placeholder="Student ID" name="student_id">
                  </div>

                  <div class="form-group col-md-2">
                    <label>Student Name</label>
                    <input type="text" class="form-control" value="{{ Request::get('student_name')}}" placeholder="Student Name" name="student_name">
                  </div>

                  <div class="form-group col-md-2">
                    <label>Student Last Name</label>
                    <input type="text" class="form-control" value="{{ Request::get('student_last_name')}}" placeholder="Student Last Name" name="student_last_name">
                  </div>
                   ...
                   <div class="card-header">
                          ...
                          <form method="post" action="{{ url('admin/attendance/report_export_excel') }}" style="float: right;">
                             {{ csrf_field() }}
                              ...
                              <input type="hidden" value="{{ Request::get('start_attendance_date')}}" name="start_attendance_date">
                              <input type="hidden" value="{{ Request::get('end_attendance_date')}}" name="end_attendance_date">
