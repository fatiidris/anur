              ...
              <form method="get"  action="" > 
                <div class="card-body">
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <input type="date" class="form-control" name="publish_date_from" value="{{ Request::get('publish_date_from') }}" placeholder="">
                    </div>

                    <div class="form-group col-md-2">
                    <label>Publish Date TO</label>
                    <input type="date" class="form-control" name="publish_date_to" value="{{ Request::get('publish_date_to') }}" placeholder="">
                    </div>
