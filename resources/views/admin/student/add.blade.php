            ...
            <div class="card card-primary">
              ...
              <form method="post"  action="" enctype="multipart/form-data" >
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-md-6">
                    <label>Parent Last Name <span style="color: red;">*</span></label>
                    <input type="text" class="form-control" name="parent_last_name" value="{{ old('parent_last_name')}}" required placeholder="Last Name">
                    <div style="color: red">{{ $errors->first('parent_last_name')}} </div>
                  </div>
                  <div class="form-group col-md-6">
