              ...
              <form method="get"  action="" > 
                <div class="card-body">
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <div class="form-group col-md-2">
                    <label>Caste</label>
                    <input type="caste" class="form-control" name="caste" value="{{ Request::get('caste') }}" placeholder="Caste">
                    </div>

                    <div class="form-group col-md-2">
                    <label>Religion</label>
                    <input type="caste" class="form-control" name="religion" value="{{ Request::get('religion') }}" placeholder="Religion">
                    </div>
          ...
          @include('_message')
            ...
            <div class="card">
              <div class="card-header">
                ...
                <form method="post" action="{{ url('admin/student/list_export_excel') }}" style="float: right;">
                             {{ csrf_field() }}
