...
class ClassTimetableController extends Controller
{
    public function list(Request $request){
        ...
        {
            $data['getSubject'] = $getSubject = ClassSubjectModel::MySubject($request->class_id);
        }
        $data['subject_id'] = $request->subject_id; //this is what i add
    ...
    public function insert_update(Request $request)
    {
        ...
        return redirect()->back()->with('success', "Class Timetable is Successfully Saved");
    }
