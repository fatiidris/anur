              ...
              <form method="get"  action="" > 
                <div class="card-body">
                  <div class="row">
                    ...
                    <input type="text" class="form-control" name="first_name" placeholder="Student First Name" value="{{ Request::get('first_name') }}">
                    </div>
                    <div class="form-group col-md-2">
                    <label>Student Last Name</label>
                    <input type="text" class="form-control" name="last_name" placeholder="Student Last Name" value="{{ Request::get('last_name') }}">
                    </div>
                    <div class="form-group col-md-2">
                    ...
                    <a href="{{ url('teacher/homework/homework/submited_homework/'.$homework_id)}}" class="btn btn-success" style="margin-top: 30px;">Reset</a>
                    </div>
                   </div>
                  </div>
              </form>
