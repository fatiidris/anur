              ...
              <form method="post"  action="" enctype="multipart/form-data" >
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="blood_group" value="{{ old('height' , $getRecord->blood_group)}}" placeholder="Blood Group">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="weight" value="{{ old('weight' , $getRecord->height)}}" placeholder="weight">
