...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>My Calender <span style="color: blue;">({{ $getStudent->name }} {{ $getStudent->last_name }})</span></h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
  ...
  @section('script')
  <script src='{{ url( 'public/fullcalendar/index.global.js' ) }}'></script>
  ...
  <script type="text/javascript">
   document.addEventListener('DOMContentLoaded', function() {
    ...
    var calender = new FullCalendar.Calendar(calenderID, {
        headerToolbar: {
