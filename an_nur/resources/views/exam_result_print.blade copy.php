...
<div id="page">
        <table style="width: 100%; text-align: center;">
            <tr>
                <td width="5%"></td>
                <td width="15%"><img style="width: 110px;" src="{{ $getSetting->getLogo() }}" style="width: auto;height: 60px;border-radius: 5px;" alt=""></td>
                <td align="left"><h1>{{ $getSetting->school_name }} </br> Minna </h1></td>
            </tr>
        </table>
            ...
            <tr>
                ...
                <td width="70%">
                    ...
                    <table class="margin-bottom" style="width: 100%;">
                        <tbody>
                            <tr>
                                <td width="23%">Admision Number : </td>
    ...
    <div>
        <table class="table-bg">
            <thead>
                <tr>
                    <th class="th text-align: left;" >Subject</th>
